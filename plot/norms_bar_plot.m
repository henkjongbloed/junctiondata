function norms_bar_plot(didx, lf, bidx, NF)
% [n, a] = D{didx(1)}{bidx(1)}.get_names("u");


tit = ["Flow velocity $\widehat{u}(y,\sigma)$", "Salinity $\widehat{s}(y,\sigma)$", "Flux $\widehat{f}(y,\sigma) = \widehat{us}(y,\sigma)$"];
...
residx_ = [0, 2, 3, 4]; % change this to 0:7 for the full flow field
residx = residx_ + 1;
sgtit = ["Junction S: Residual component norms", "Junction N: Residual component norms"];
for di = didx
