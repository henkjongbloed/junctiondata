function plotTidalEllipses(U, F)
...
%      = U{j}.xs.sn2xy_vel(F{j}.vc{1, 3});    
    ...
    % Tidal Ellipses
    plot(U{j}.mesh_mean.x_middle + u1(1,:) ,  U{j}.mesh_mean.y_middle + v1(1,:), 'b*') % Tidal flow, DA
    plot(U{j}.mesh_mean.x_middle + u2_b(1,:),  U{j}.mesh_mean.y_middle + v2_b(1,:), 'r*') % Tidal flow, Bottom
    plot(U{j}.mesh_mean.x_middle + u2_s(1,:),  U{j}.mesh_mean.y_middle + v2_s(1,:), 'g*') % Tidal flow, Surface
