...
D2 = sparse(rows, cols, vals, 6*LBS.mesh.ncells*(2*length(LBS.velocity_model.constituentsU)+1), LBS.mesh.ncells*sum(LBS.velocity_model.npars));
% spy(Cg)
plot(sum(abs(D2),2))
end